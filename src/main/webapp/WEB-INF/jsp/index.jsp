...
<!-- 上 -->
<div
data-options="region:'north',height:100,title:'第五组的项目展示中心',collapsidle:false" style="z-index:999999;background: url(${path}/images/66.jpg);background-size:100%，100%">
...
<div class="easyui-accordion" data-options="fit:true,selected:0">
	...
	<div data-options="title:'培训管理'">
		<ul id="asynTree10"></ul>
	</div>

	<div data-options="title:'面试题管理'">
		<ul id="asynTree11"></ul>
	</div>
...
<script type="text/javascript">
	...
	$("#asynTree10").tree({
		url:"<%=request.getContextPath() %>/trainTree",
	...
	$("#asynTree11").tree({
		url:"<%=request.getContextPath() %>/interviewTree",
